...
define('CATEGORY_VALIDATION_ERROR', 'The category name should be at least 3 characters long.');
...
define('PRODUCT_VALIDATION_ERROR', 'The product name should be at least 2 characters long.');
