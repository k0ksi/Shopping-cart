CREATE SCHEMA `cart_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
...
INSERT INTO `cart`.`products` (`id`, `name`, `description`, `price`, `quantity`) VALUES ('1', 'Gloves', 'Adidas Winter Gloves', '20', '15');
INSERT INTO `cart`.`products` (`id`, `name`, `description`, `price`, `quantity`) VALUES ('2', 'Pod Igoto', 'Pod Igoto by Ivan Vazov', '7', '45');
INSERT INTO `cart`.`products` (`id`, `name`, `description`, `price`, `quantity`) VALUES ('3', 'Transformers Toys', 'Transformers Original Toys', '40', '7');
INSERT INTO `cart`.`products` (`id`, `name`, `description`, `price`, `quantity`) VALUES ('4', 'ACER 5741G', 'Laptop Acer 5741G As good as new', '699', '3');
INSERT INTO `cart`.`products` (`id`, `name`, `description`, `price`, `quantity`) VALUES ('5', 'Lenovo M5400', 'Lenovo M5400 Laptop with a few cosmetic defects', '799', '2');
INSERT INTO `cart`.`products` (`id`, `name`, `description`, `price`, `quantity`) VALUES ('6', 'Windows 10 Enterprise Edition', 'Licensed Windows 10 Enterprise', '500', '40');
INSERT INTO `cart`.`products` (`id`, `name`, `description`, `price`, `quantity`) VALUES ('7', 'AutoCAD', 'AutoCAD with License', '300', '20');
INSERT INTO `cart`.`products` (`id`, `name`, `description`, `price`, `quantity`) VALUES ('8', 'The hills have eyes', 'The hills have eyes BluRay 720p', '15', '30');
INSERT INTO `cart`.`products` (`name`, `description`, `price`, `quantity`) VALUES ('Titanic', 'Titanic DVD', '5', '60');
INSERT INTO `cart`.`products` (`name`, `description`, `price`, `quantity`) VALUES ('Pride & Prejudice', 'Pride & Prejudice BluRay 1080p', '20', '300');
INSERT INTO `cart`.`products` (`name`, `description`, `price`, `quantity`) VALUES ('MacBookPro 13', 'MacBookPro 13inch Intel i5 NVIDIA 760GTX', '2400', '3');
...
INSERT INTO `users` (`id`, `username`, `password`, `is_admin`, `is_editor`) VALUES
